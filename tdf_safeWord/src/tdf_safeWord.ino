...
const String hapticReceive = "com.desInv202.project2.safeWord.0a10aced202194944a043d48";
...
void sendHapticRequest() {
    ...
    Particle.publish(hapticSend + eliza_deviceID, messageOut);
}
